...
@AllArgsConstructor
@NoArgsConstructor
public class OrderItem_old extends BaseEntity {
...
/**
    ...
    public static OrderItem_old createOrderItem(Item item, int count){
        OrderItem_old orderItem = new OrderItem_old();  // 주문 상품 생성
