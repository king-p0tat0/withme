  ...
  return (
    <div className="modal">
      <div className="modal-content">
        ...
        <button onClick={() => handleApprove(doctor.member.email, "approved")}>
          승인
        </button>
        <button onClick={() => handleApprove(doctor.member.email, "rejected")}>
          거절
        </button>
        <button onClick={() => handleApprove(doctor.member.email, "on_hold")}>
          보류
        </button>
        <button onClick={() => handleApprove(doctor.member.email, "pending")}>
          대기
        </button>
